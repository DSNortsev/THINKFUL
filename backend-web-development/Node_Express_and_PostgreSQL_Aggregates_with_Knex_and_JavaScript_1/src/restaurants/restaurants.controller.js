...
async function averageRating(req, res, next) {
  // your solution here
  const rating = await service.averageRating();
  res.json({ data: { average_rating: Number(rating.average)} });
}
...
async function count(req, res, next) {
  // your solution here
  const restaurantCount = await service.count();
  res.json({ data: {count: Number(restaurantCount.count)}});
}
...
async function readHighestRating(req, res, next) {
  // your solution here
  const highestRating = await service.readHighestRating();
  res.json({ data: { max_rating: highestRating.rating} });
}
