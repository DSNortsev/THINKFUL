class BinarySearchTree {
  ...
  countLeaves(count = 0) {
    ...
    const leftCount = this.left ? this.left.countLeaves() : count;
    const rightCount = this.right ? this.right.countLeaves() : count;
  ...
  isBalancedBST() {
    ...
    const isLeftBalanced = this.left ? this.left.isBalancedBST() !== -1 : true;
    const isRightBalanced = this.right ? this.right.isBalancedBST() !== -1 : true;
    
    if (Math.abs(leftHeight - rightHeight) <= 1 && isLeftBalanced && isRightBalanced) {
